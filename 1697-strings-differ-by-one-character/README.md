<h2><a href="https://leetcode.com/problems/strings-differ-by-one-character">Strings Differ by One Character</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Given a list of strings <code>dict</code> where all the strings are of the same length.</p>
